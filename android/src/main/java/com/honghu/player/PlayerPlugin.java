...
public class PlayerPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    flutterPluginBinding.getPlatformViewRegistry().registerViewFactory("plugin.honghu.com/ali_video_play_single_", new ShareFAliSinglePlayerFactory(flutterPluginBinding.getBinaryMessenger()));
  }
