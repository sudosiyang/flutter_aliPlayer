...
class AliSlider extends StatefulWidget {
  ...
  const AliSlider({
    ...
    this.min = 0.0,
    this.max = 1.0,
    this.colors = const AliSliderColors(),
  })  : assert(value != null),
...
/// Colors for the AliSlider
class AliSliderColors {
  const AliSliderColors({
...
class _SliderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    double lineHeight = min(size.height / 2, 1.2);
    ...
    radius = min(size.height / 2, dragging ?  8: 7);
