...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    controller.onPlayEvent.listen((event) {
      if (event == AVPEventType.AVPEventCreated) {
        ...
        controller.setSource(
            url:
                'http://vod.apuscn.com/hundun/05fb46f656b94a71ac75048c0b565b78/05fb46f656b94a71ac75048c0b565b78.m3u8');
        print('set source');
      }
    ...
    // });
    controller.onFullScreenChange.listen((event) {
      if (Platform.isIOS) {
        setState(() {
          fullScreen = event == AVPScreenStatus.FULLSCREEN;
        });
      }
    });
  }
